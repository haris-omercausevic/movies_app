...
class FacebookLoginButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: RaisedButton(
        color: appTheme.facebookBackgroundColor,
        onPressed: () async {
          //TODO: Make FacebookLogin work, probably App Secret needed
            ...
            case FacebookLoginStatus.error:
              ...
              authenticationBloc.add(
                AuthenticateWithFacebook(
                  body: AuthenticationFacebookLoginBody(
                    id: result.accessToken.userId,
                    firstName: "Salih",
                    lastName: "Agic",
                    email: "salih.agic@outlook.com",
                    gender: 'M',
                    name: "Sale",
                  ),
                ),
        ...
        textColor: Colors.white,
        //color: Constants.primaryAccentColorDarkTheme,
        padding: const EdgeInsets.all(8.0),
        child: Padding(
          padding: const EdgeInsets.fromLTRB(30.0, 10, 30.0, 10.0),
          child: Text(
